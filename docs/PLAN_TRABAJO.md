...
| VIS-001 | Home | Correccion visual del Hero, metricas y presencia nacional | Completado | Home base existente, recursos locales confirmados y necesidad de fidelidad al mockup de Comunicacion | Hero de ancho completo, metricas ampliadas y presencia nacional escalada con validaciones visuales | `pendiente` |
