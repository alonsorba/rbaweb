        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            ...
            <div class="carousel-caption">
              ...
              <h2 class="fw-semibold mb-2">Acompa僅amos cada decision de cobertura.</h2>
              <p class="mb-0 text-white-80">Planes claros, sin letras peque僅as y listos para tus operaciones.</p>
            </div>
          </div>
          <div class="swiper-slide">
      ...
      <div class="container">
        <div class="row align-items-center mb-4">
          <div class="col-lg-8">
            ...
            <h2 class="fw-semibold">Coberturas dise造adas para empresas y familias.</h2>
        ...
        <div class="row g-4">
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="tile h-100">
              ...
              <p class="text-muted">Soluciones de prevision, ahorro y retiro con acompa造amiento humano y transparente.</p>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="tile h-100">
              ...
              <p class="text-muted">Acompa造amiento inmediato, coordinacion con ajustadores y gestion hasta el pago.</p>
          ...
          <div class="col-lg-6">
            ...
            <ul class="list-unstyled d-grid gap-3">
              <li class="d-flex gap-3 align-items-start">
                ...
                <div>
                  <h6 class="mb-1 fw-semibold">Dise造o y tecnologia</h6>
              ...
              <li class="d-flex gap-3 align-items-start">
                ...
                <div>
                  ...
                  <p class="mb-0 text-muted">Sin letras peque造as: indicadores de riesgo y cobertura en dashboards simples.</p>
                </div>
              </li>
            </ul>
